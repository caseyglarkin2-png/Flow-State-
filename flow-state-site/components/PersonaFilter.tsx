...
import { Briefcase, Cog, Shield, Server } from "lucide-react";

type Persona = "CFO" | "Ops" | "Security" | "IT" | "All";

const personas: { value: Persona; label: string; icon: React.ReactNode }[] = [
  { value: "All", label: "All", icon: null },
  { value: "CFO", label: "Finance", icon: <Briefcase className="h-4 w-4" /> },
  { value: "Ops", label: "Operations", icon: <Cog className="h-4 w-4" /> },
