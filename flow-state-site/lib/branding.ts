...
export const SITE_METADATA = {
  ...
  ogTitle: 'YardFlow powered by FreightRoll | Yard Network System (YNS)',
  ogDescription: 'Stop the network leak. YNS enables orchestration, security, and scale across your entire yard network.',
